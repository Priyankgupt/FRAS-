...
def contact():
     mess._show(title='Contact us', message="Please contact us on : 'priyank9811.pg@gmail.com' ")
...
# to take images and create dataset
def TakeImages():
...
#to train images from dataset to get captured for attendance
def TrainImages():
    check_haarcascadefile()
    assure_path_exists("TrainingImageLabel/")
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="white"  ,bg="#ce4f3e"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="white"  ,bg="#ce4f3e"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="white"  ,bg="#ce4f3e"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="white"  ,bg="#ce4f3e"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="white"  ,bg="#ce4f3e"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trackImg.place(x=30,y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="white"  ,bg="#ce4f3e"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
